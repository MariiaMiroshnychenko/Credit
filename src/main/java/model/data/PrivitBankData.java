...
public enum PrivitBankData {
    CHANGE_CAR_CREDIT(new PrivitBankCredit(45000, 60, 15, true, true, PrivitBankCredit.PrivitBankPurpose.FOR_CAR)),
    CHANGE_FLAT_CREDIT(new PrivitBankCredit(75000, 72, 35, true, false, PrivitBankCredit.PrivitBankPurpose.FOR_REAL_ESTATE)),
    CHANGE_DEVICE_CREDIT(new PrivitBankCredit(1500, 20, 0, true, false, PrivitBankCredit.PrivitBankPurpose.FOR_DEVICE)),
    CREATE_BUSINESS_CREDIT(new PrivitBankCredit(50000, 360, 40, true, true, PrivitBankCredit.PrivitBankPurpose.FOR_BUSINESS));
