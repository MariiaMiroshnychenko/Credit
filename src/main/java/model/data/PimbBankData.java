...
public enum PimbBankData {
    FLAT_CREDIT(new PimbBankCredit(100000, 240, 45, true, true, PimbBankCredit.PimbBankPurpose.FOR_REAL_ESTATE)),
    FLAT_REPAIR(new PimbBankCredit(10000, 60, 15, true, false, PimbBankCredit.PimbBankPurpose.FOR_APARTMENT_REPAIR)),
    EQUIPMENT_CREDIT(new PimbBankCredit(2000, 36, 0, true, false, PimbBankCredit.PimbBankPurpose.FOR_DEVICE)),
